...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<actionpack>.freeze, [">= 3.0".freeze])
  s.add_runtime_dependency(%q<railties>.freeze, [">= 3.0".freeze])
  s.add_runtime_dependency(%q<rspec-core>.freeze, ["~> 3.9.0".freeze])
  s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.9.0".freeze])
  s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.9.0".freeze])
  s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.9.0".freeze])
  s.add_development_dependency(%q<cucumber>.freeze, ["~> 1.3.5".freeze])
  s.add_development_dependency(%q<aruba>.freeze, ["~> 0.14.12".freeze])
  s.add_development_dependency(%q<ammeter>.freeze, ["~> 1.1.2".freeze])
end
